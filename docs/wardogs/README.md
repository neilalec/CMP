...
The frontend model is ready to represent three faction rosters. The architecture documents propose a backend contract; they do not implement one or establish a WARDOGS match-completion signal. Development can proceed with a manual/referee result path while lifecycle automation remains unverified.
