...
This directory records durable product decisions and the implementation roadmap. The [product model](PRODUCT.md), [roadmap](ROADMAP.md), and [decision log](DECISIONS.md) are the current planning references.
...
The frontend model is ready to represent three faction rosters. It does not establish a backend contract or WARDOGS match-completion signal.
