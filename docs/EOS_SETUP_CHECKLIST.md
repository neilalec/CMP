...
- [ ] 1. Open [backend/.env](C:/Users/neila/Desktop/CMP_dev/backend/.env).
- [ ] 2. Copy the lines from [backend/.env.eos.example](C:/Users/neila/Desktop/CMP_dev/backend/.env.eos.example) into the bottom of [backend/.env](C:/Users/neila/Desktop/CMP_dev/backend/.env).
...
- [ ] 7. Copy [tools/steam-ticket/.env.example](C:/Users/neila/Desktop/CMP_dev/tools/steam-ticket/.env.example) to `tools/steam-ticket/.env`.
...
- [ ] 10. Open a terminal in `C:\Users\neila\Desktop\CMP_dev`.
- [ ] 11. Run:
...
- [ ] 14. Paste that value into `EOS_STEAM_SESSION_TICKET_HEX` inside [backend/.env](C:/Users/neila/Desktop/CMP_dev/backend/.env).
- [ ] 15. Run:
...
- [ ] 17. Paste that full token value into `EOS_ACCESS_TOKEN` inside [backend/.env](C:/Users/neila/Desktop/CMP_dev/backend/.env).
