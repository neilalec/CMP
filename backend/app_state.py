...
if DEV_GAME_TARGET not in {'local', 'wardogs', 'squad'}:
    raise RuntimeError('CMP_DEV_GAME must be "local", "wardogs", or "squad" when CMP_DEV_MODE=1')
...
DEV_SOLO_ELO_SMOKE_ENABLED = os.getenv('DEV_SOLO_ELO_SMOKE_ENABLED', '0') == '1'
DEV_SOLO_ELO_SMOKE_USERNAME = os.getenv(
    'DEV_SOLO_ELO_SMOKE_USERNAME',
    DEV_LIVE_ROLL_OVERRIDE_USERNAME or 'neil'
).strip().lower()
